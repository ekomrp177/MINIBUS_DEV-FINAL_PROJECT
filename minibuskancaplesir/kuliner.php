...
$data = mysqli_query($connect,"SELECT *FROM kuliner");

if( isset($_POST["Search"])){
  $key=$_POST["keyword"];
  $data = mysqli_query($connect,"SELECT * FROM kuliner where Name like '%$key%'
...
<html lang="en">
  ...
  <form action="" method="POST">
    <div class="row mt-3 justify-content-center">
      <div class="col-md-10">      
        <h1 class="text-center">Search Kuliner</h1>
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="kuliner..." id="search-input"name="keyword" >
      ...
      <div class="col-md-4 lg-4 d-flex align-items-stretch">      
        ...
        <img src="img/gambar.png" class="card-img-top">
          ...
          <div class="card-footer text-muted">
             <a href="detailkuliner.php?id_kuliner=<?php echo $row["id"]?>" class="btn btn-dark" role="button">detail</a>
          </div>
        </div>
      </div>
      <?php endforeach; ?>
